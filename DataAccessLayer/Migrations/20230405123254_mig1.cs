    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2005, 4, 5, 15, 32, 54, 499, DateTimeKind.Local).AddTicks(9047), "MAT101", "Hakan Emre", "Yeşil" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin", "admin", "admin", 1, null, "admin" },
                    { 2, "user", "user", "user", 2, null, "user" },
                    { 3, "Yeşil", "Hakan Emre", "12345", 2, 1, "hakan" }
                });
